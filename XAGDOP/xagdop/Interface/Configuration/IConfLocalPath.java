...
//		CPreferencies.setLocalPath(jTextField1.getName());
		...
		File localPath = new File(jTextField1.getText());
		if(localPath.exists()){
			...
			ErrorManager.getInstance().setErrTitle(Bundle.getText("error.pathUnavaible.title"));
			ErrorManager.getInstance().setErrMsg(Bundle.getText("error.pathUnavaible.msg"));
