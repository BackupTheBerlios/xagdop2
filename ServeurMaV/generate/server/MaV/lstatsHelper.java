...
abstract public class lstatsHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = MaV.StatsHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (MaV.lstatsHelper.id (), "lstats", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    MaV.Stats value[] = null;
    int _len0 = istream.read_long ();
    value = new MaV.Stats[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = MaV.StatsHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, MaV.Stats[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      MaV.StatsHelper.write (ostream, value[_i0]);
  }
