...
{
  private static String  _id = "IDL:MaV/Stats/Stats:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (MaV.StatsHelper.id (), "Stats", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    MaV.Stats value = new MaV.Stats ();
    value.idCandidat = istream.read_ulong ();
    value.idBureau = istream.read_ulong ();
    value.nbVotes = istream.read_ulong ();
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, MaV.Stats value)
  {
    ostream.write_ulong (value.idCandidat);
    ostream.write_ulong (value.idBureau);
    ostream.write_ulong (value.nbVotes);
  }
